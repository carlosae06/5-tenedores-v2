...
export function ChangePasswordForm(props) {
    ...
    const formik = useFormik (
        {
            ...
            onSubmit: async (formValue) => {
                try {
                    ...
                    console.log(error);
                    Toast.show({type: 'error', position: 'bottom', text1: 'Error al cambiar el password.'});
                }
            }
        }
    )
  return (
    <View style={styles.content}>
        <Input placeholder='Password actual' 
        ...
        />
        <Input placeholder='Password nuevo' 
            containerStyle={styles.input}
            secureTextEntry={showPassword ? false : true}
            rightIcon={{type: 'material-community', name: showPassword ? 'eye-off-outline' : 'eye-outline', color: '#C2C2C2',
                onPress: onShowPassword,
        ...
        />
        <Input placeholder='Repite el password nuevo' 
            containerStyle={styles.input}
            secureTextEntry={showPassword ? false : true}
            rightIcon={{type: 'material-community', name: showPassword ? 'eye-off-outline' : 'eye-outline', color: '#C2C2C2',
                onPress: onShowPassword,
